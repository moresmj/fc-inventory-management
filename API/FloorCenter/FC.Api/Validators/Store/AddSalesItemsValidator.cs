...
{
    public class AddSalesItemsValidator : AbstractValidator<AddSalesItems>
    {

        private readonly DataContext _context;

        public AddSalesItemsValidator(DataContext context)
        {
        ...
        private bool NotMoreThanAvailableQuantity(AddSalesItems model)
        {
        ...
        private bool ValidItem(AddSalesItems model)
        {
            if (model.StoreId.HasValue)
            {
