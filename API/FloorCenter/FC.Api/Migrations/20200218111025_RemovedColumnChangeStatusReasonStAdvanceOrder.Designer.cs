...
namespace FC.Api.Migrations
{
    ...
    [Migration("20200218111025_RemovedColumnChangeStatusReasonStAdvanceOrder")]
    partial class RemovedColumnChangeStatusReasonStAdvanceOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STAdvanceOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("changeStatusReasons");

                    b.HasKey("Id");

                    b.HasIndex("StoreId");

                    b.HasIndex("WarehouseId", "StoreId");

                    b.ToTable("STAdvanceOrder");
                });

            modelBuilder.Entity("FC.Core.Domain.Stores.STAdvanceOrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("STAdvanceOrderId");
                    ...
                    b.HasIndex("STAdvanceOrderId");

                    b.HasIndex("ItemId", "STAdvanceOrderId");

                    b.ToTable("STAdvanceOrderDetails");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STDelivery", b =>
                {
                    ...
                    b.Property<bool>("IsRemainingForReceivingDelivery");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STOrder", b =>
                {
                    ...
                    b.Property<bool?>("isAdvanceOrderFlg");

                    b.Property<bool?>("isDealerOrder");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STShowroomDelivery", b =>
                {
                    ...
                    b.Property<bool>("IsRemainingForReceiving");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STStock", b =>
                {
                    ...
                    b.Property<bool>("IsDeliveryTransfer");
            ...
            modelBuilder.Entity("FC.Core.Domain.Users.StoreDealerAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("StoreDealerAssignment");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHAllocateAdvanceOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("WHAllocateAdvanceOrder");
                });

            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHAllocateAdvanceOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("WHAllocateAdvanceOrderId");

                    b.HasKey("Id");

                    b.HasIndex("WHAllocateAdvanceOrderId");

                    b.ToTable("WHAllocateAdvanceOrderDetail");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHImportDetail", b =>
                {
                    ...
                    b.Property<int?>("ReserveAdjustment");
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHModifyItemTonality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("WarehouseId", "STOrderId");

                    b.ToTable("WHModifyItemTonality");
                });

            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHModifyItemTonalityDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("WHModifyItemTonalityId");

                    b.HasKey("Id");

                    b.HasIndex("ItemId");

                    b.HasIndex("WHModifyItemTonalityId", "ItemId");

                    b.ToTable("WHModifyItemTonalityDetails");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHStock", b =>
                {
                    ...
                    b.Property<int?>("WHAllocateAdvanceOrderDetailId");
                    ...
                    b.HasIndex("WHAllocateAdvanceOrderDetailId");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STAdvanceOrderDetails", b =>
                {
                    ...
                    b.HasOne("FC.Core.Domain.Stores.STAdvanceOrder")
                        .WithMany("AdvanceOrderDetails")
                        .HasForeignKey("STAdvanceOrderId");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STDelivery", b =>
                {
                    ...
                    b.HasOne("FC.Core.Domain.Stores.STSales", "Sales")
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("FC.Core.Domain.Users.StoreDealerAssignment", b =>
                {
                    ...
                    b.HasOne("FC.Core.Domain.Users.User", "User")
                        .WithMany("StoreDealerAssignment")
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHAllocateAdvanceOrderDetail", b =>
                {
                    b.HasOne("FC.Core.Domain.Warehouses.WHAllocateAdvanceOrder")
                        .WithMany("AllocateAdvanceOrderDetails")
                        .HasForeignKey("WHAllocateAdvanceOrderId");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHModifyItemTonalityDetails", b =>
                {
                    ...
                    b.HasOne("FC.Core.Domain.Warehouses.WHModifyItemTonality")
                        .WithMany("ModifyItemTonalityDetails")
                        .HasForeignKey("WHModifyItemTonalityId");
                });
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHStock", b =>
                {
                    ...
                    b.HasOne("FC.Core.Domain.Warehouses.WHAllocateAdvanceOrderDetail", "WHAllocateAdvanceOrderDetail")
                        .WithMany()
                        .HasForeignKey("WHAllocateAdvanceOrderDetailId");
