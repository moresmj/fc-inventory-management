...
namespace FC.Api.Migrations
{
    ...
    [Migration("20180523030446_AddStringIndexMaxLengths")]
    partial class AddStringIndexMaxLengths
    {
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STDelivery", b =>
                {
                    ...
                    b.HasIndex("StoreId", "STOrderId", "STSalesId");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STOrder", b =>
                {
                    ...
                    b.HasIndex("StoreId", "OrderType", "TransactionNo", "PONumber", "WarehouseId");
            ...
            modelBuilder.Entity("FC.Core.Domain.Stores.STStock", b =>
                {
                    ...
                    b.HasIndex("ItemId", "StoreId", "OnHand", "ReleaseStatus", "DeliveryStatus");
            ...
            modelBuilder.Entity("FC.Core.Domain.Users.User", b =>
                {
                    ...
                    b.HasIndex("UserName", "StoreId", "WarehouseId");
            ...
            modelBuilder.Entity("FC.Core.Domain.Warehouses.WHStock", b =>
                {
                    ...
                    b.HasIndex("ItemId", "WarehouseId", "OnHand", "DeliveryStatus", "ReleaseStatus");
