...
namespace InventorySystemAPI.Migrations
{
    ...
    [Migration("20180214083405_AddedItemAttributeTable")]
    partial class AddedItemAttributeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Attribute.ItemAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Category.CategoryChild", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Category.CategoryGrandChild", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CategoryGrandChild");
                });

            modelBuilder.Entity("InventorySystemAPI.Models.Item.Category.CategoryParent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Item", b =>
                {
                    ...
                    b.Property<int?>("ItemAttributeId1");
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Category.CategoryChild", b =>
                {
                    b.HasOne("InventorySystemAPI.Models.Item.Category.CategoryParent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Category.CategoryGrandChild", b =>
                {
                    b.HasOne("InventorySystemAPI.Models.Item.Category.CategoryChild")
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Item.Item", b =>
                {
                    b.HasOne("InventorySystemAPI.Models.Item.Category.CategoryChild", "CategoryChild")
                        .WithMany()
                        .HasForeignKey("CategoryChildId");

                    b.HasOne("InventorySystemAPI.Models.Item.Category.CategoryGrandChild", "CategoryGrandChild")
                        .WithMany()
                        .HasForeignKey("CategoryGrandChildId");

                    b.HasOne("InventorySystemAPI.Models.Item.Category.CategoryParent", "CategoryParent")
                        .WithMany()
                        .HasForeignKey("CategoryParentId");

                    b.HasOne("InventorySystemAPI.Models.Item.Attribute.ItemAttribute", "ItemAttribute")
                        .WithMany()
            ...
            modelBuilder.Entity("InventorySystemAPI.Models.Store.Request.STDeliveryDetail", b =>
                {
                    ...
                    b.HasOne("InventorySystemAPI.Models.Store.Request.STDelivery")
