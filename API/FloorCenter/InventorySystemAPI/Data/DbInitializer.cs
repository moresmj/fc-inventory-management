...
namespace InventorySystemAPI.Data
{
    ...
    /// <summary>
    /// This class is used to populate database tables with default data
    /// </summary>
    public static class DbInitializer
    {

        public static void Initialize(FloorCenterContext context)
        {
        ...
        private static void AddDefaultWarehouses(FloorCenterContext context)
        {
            ...
            {
                new Warehouse { Code = "MLA", Name = "MANILA", DateCreated = DateTime.Now },
                new Warehouse { Code = "CAG", Name = "CAGAYAN", DateCreated = DateTime.Now },
                new Warehouse { Code = "CEB", Name = "CEBU", DateCreated = DateTime.Now },
                new Warehouse { Code = "DVO", Name = "DAVAO", DateCreated = DateTime.Now }
            };
        ...
        private static void AddDefaultCompanies(FloorCenterContext context)
        {
        ...
        private static void AddDefaultStores(FloorCenterContext context)
        {
            // Look for any stores
            ...
            {
                new Store { Code="F3J2-1", Name="1125", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-3", Name="ANGELES", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-4", Name="COMMONWEALTH", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-5", Name="LIBIS", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-6", Name="MC-ARTHUR", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-7", Name="MEXICO", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-8", Name="MUÑOZ", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-9", Name="QUEZON AVENUE", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-10", Name="ROSARIO", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-11", Name="SAN FERNANDO", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-12", Name="SM-NORTH EDSA", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-15", Name="SACOP", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-16", Name="PROJECT MUÑOZ", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-17", Name="VISAYAS AVENUE", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3J2-18", Name="1252", CompanyId=1, DateCreated=DateTime.Now },
                new Store { Code="F3T4-1", Name="ROXAS BLVD", CompanyId=2, DateCreated=DateTime.Now },
                new Store { Code="F3T4-2", Name="DIVERSION", CompanyId=2, DateCreated=DateTime.Now },
                new Store { Code="F3T4-3", Name="ANTIPOLO", CompanyId=2, DateCreated=DateTime.Now },
                new Store { Code="F3F4-1", Name="BINONDO", CompanyId=3, DateCreated=DateTime.Now },
                new Store { Code="F3F4-2", Name="CAINTA", CompanyId=3, DateCreated=DateTime.Now },
                new Store { Code="F3F4-3", Name="LEMERY", CompanyId=3, DateCreated=DateTime.Now },
                new Store { Code="F3F4-4", Name="LIPA", CompanyId=3, DateCreated=DateTime.Now },
                new Store { Code="F3F2-1", Name="PROJECT ROXAS", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3F2-3", Name="IMUS", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3F2-4", Name="KAWIT", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3F2-5", Name="MAKATI", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3F2-6", Name="MOLINO", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3F2-8", Name="PROJECT MAKATI", CompanyId=4, DateCreated=DateTime.Now },
                new Store { Code="F3S2-1", Name="BAJADA", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-2", Name="BUHANGIN", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-3", Name="BULUA", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-4", Name="BUTUAN", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-7", Name="MATINA", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-9", Name="VALENCIA", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-10", Name="LAPASAN", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-11", Name="ECOLAND", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-13", Name="TETUAN", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-14", Name="COTABATO", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-15", Name="VETERANS", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-16", Name="ILIGAN", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-17", Name="MANDAUE", CompanyId=5, DateCreated=DateTime.Now },
                new Store { Code="F3S2-5", Name="GENERAL SANTOS", CompanyId=6, DateCreated=DateTime.Now },
                new Store { Code="F3S2-6", Name="SARGEN MARBEL", CompanyId=7, DateCreated=DateTime.Now }
            };
        ...
        private static void AddDefaultSizes(FloorCenterContext context)
        {
        ...
        private static void AddDefaultItemCategories(FloorCenterContext context)
        {
        ...
        private static void AddCategoryParentChildren(FloorCenterContext context, int Id)
        {
        ...
        private static void AddCategoryChildrenGrandChildren(FloorCenterContext context, int CategoryChildId)
        {
