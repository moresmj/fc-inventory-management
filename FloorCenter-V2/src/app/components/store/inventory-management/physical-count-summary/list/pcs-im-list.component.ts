...
export class PhysicalCountSummaryListComponent {
  ...
  {
    this._inventoriesService.action = "store/physicalcount/summary";
  }
  ...
  toModel(detail : any): Inventories {
      let model = new Inventories({
        ...
        OnHand : (detail.dateCreated != null) ? new Date(detail.dateCreated).toLocaleString() : '',
  ...
  downloadList(){
    ...
    this._requestService.action = "inventories/store/physicalcount/summary";
