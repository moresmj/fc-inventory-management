...
@Component({
  selector:  'app-register-store-breakage',
  templateUrl: './register-store-breakage.html'
})


export class RegisterStoreBreakageComponent implements AfterViewInit, OnInit{
  ...
  itemList : any;
		...
		) 
	{
      ...
      this._apiBaseService.action = "imports/physicalcount/breakage/store";
    ...
    addNewRow(data: any,qty : any) {
      ...
      let newItem = this.fb.group({
        ...
        Broken: new FormControl(0, [Validators.required, CustomValidator.quantity]),
        Remarks: ['']
      })
      // add new formgroup
