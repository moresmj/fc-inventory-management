...
@Component({
	selector: 'app-ar-orders-dealer-advanced-search',
	templateUrl: './ar-orders-dealer-advanced-search.html'
})

export class ApproveRequestOrdersDealerAdvancedSearchComponent {
