...
@Component({
	selector: 'app-ar-orders-dealer-list',
	templateUrl: './ar-orders-dealer-list.html'
})

export class ApproveRequestOrdersDealerListComponent {
	...
	{
		this.defaultFilter = { "requestStatus" : [2], "isDealer" : true };
