...
@Component({
	selector: 'app-ar-returns-details',
	templateUrl: './ar-returns-details.html'
})

export class ApproveRequestReturnsDetailsComponent {
	...
	onSubmit(data : any) {
		...
		this._requestService.action = "transactions/approverequests/returns/purchasereturn";
