...
@Component({
	selector: 'app-change-tonality-advanced-search',
	templateUrl: './change-tonality-advanced-search.html'
})

export class ApproveRequestChangeTonalityAdvancedSearchComponent {
