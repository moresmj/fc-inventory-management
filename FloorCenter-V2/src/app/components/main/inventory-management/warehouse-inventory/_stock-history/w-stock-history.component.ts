...
export class WarehouseStockHistoryComponent {
	...
	search : string;
	module : string = "m-inv-warehouse-stock-history";
		...
		private _apiBaseService : ApiBaseService) 
	{
	    this.route.queryParams.subscribe(
     		data => 
     		 	{ 
     		 		this.defaultFilter = { id : data["id"], warehouseId : data["warehouseId"] };
	...
	var options = {
		...
		decimalseparator: '.',
		showLabels: true,
		headers: ['Transaction No.', 'Transaction', 'PO No.', 'DR No.', 'SI No.', 'Origin', 'Destination', 'Transaction Date', 'Stock']
